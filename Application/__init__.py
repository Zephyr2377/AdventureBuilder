import random
from character.models import char_dict, characters_rand
from item.models import char_items, obj_dict
from world.models import my_world


my_damage = 15


rand = ['mud'] * 6 + ['grass'] * 6 + ['wood'] * 3 + ['flowers'] * 3 + ['rock'] * 6 + ['rags', 'dagger',
                                                                                      'club']  # there should be a way of having different sets of rands for different world parts ( deserts, foests, etc )
